...
// rótulos secciones
	svg3.append("text")
		...
		.text("5.001 biztanle baino gutxiago")
		//.text(becasMaterial)
...
// rótulos ejes
	...
	legend3.selectAll('div')
		...
		.on('click',function(d) { //when click on name
			...
			if ( d.zona3 == "Guztiak") {
				zona3.select("p").html("<strong>Udalerri guztiak</strong>");
			} else {
				zona3.select("p").html("<strong>"+d.zona+"</strong>. <span style='font-size:0.7em'>%"+ 
